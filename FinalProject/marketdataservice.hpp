...
{
	auto OrderComp = [](const Order& o1, const Order& o2)
	{
		return o1.GetPrice() < o2.GetPrice();
	};

	
	Order bestBid = *std::max_element(bidStack.begin(), bidStack.end(), OrderComp);
	Order bestOffer = *std::min_element(offerStack.begin(), offerStack.end(), OrderComp);
